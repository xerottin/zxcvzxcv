...
@router.post(
    "/create", response_model=MenuItemResponse, status_code=status.HTTP_201_CREATED
)
...
@router.get(
    "/{menu_item_id}", response_model=MenuItemResponse, status_code=status.HTTP_200_OK
)
