...
class Menu(BaseModel):
    ...
    branch: Mapped["Branch"] = relationship(
        "Branch", back_populates="menu", uselist=False
    )
    menu_item: Mapped[List["MenuItem"]] = relationship(
...
class MenuItem(BaseModel):
    ...
    menu: Mapped["Menu"] = relationship(
        "Menu", back_populates="menu_item", uselist=False
    )
    basket: Mapped["Basket"] = relationship(
        "Basket", back_populates="menu_item", cascade="all, delete-orphan"
    )
