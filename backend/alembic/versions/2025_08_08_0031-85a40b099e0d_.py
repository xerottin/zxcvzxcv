...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_verification_code_code"), "verification_code", ["code"], unique=False
    )
    op.create_index(
        op.f("ix_verification_code_email"), "verification_code", ["email"], unique=False
    )
    op.create_index(
        op.f("ix_verification_code_phone"), "verification_code", ["phone"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.create_index(
        "ix_verification_codes_phone", "verification_codes", ["phone"], unique=False
    )
    op.create_index(
        "ix_verification_codes_email", "verification_codes", ["email"], unique=False
    )
    op.create_index(
        "ix_verification_codes_code", "verification_codes", ["code"], unique=False
    )
