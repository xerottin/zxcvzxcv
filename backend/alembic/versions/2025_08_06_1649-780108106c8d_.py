...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "PROCESSING", "SUCCEEDED", "FAILED", "CANCELLED", "REFUNDED", name="payment_status"),
            nullable=False,
        ),
        sa.Column("payment_method", sa.Enum("CARD", "WALLET", "BANK_TRANSFER", name="payment_method"), nullable=True),
