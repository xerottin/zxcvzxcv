...
def downgrade() -> None:
    ...
    sa.Column('stripe_payment_intent_id', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('amount', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('currency', sa.VARCHAR(length=3), autoincrement=False, nullable=False),
    sa.Column('status', postgresql.ENUM('PENDING', 'PROCESSING', 'SUCCEEDED', 'FAILED', 'CANCELLED', 'REFUNDED', name='payment_status'), autoincrement=False, nullable=False),
    sa.Column('payment_method', postgresql.ENUM('CARD', 'WALLET', 'BANK_TRANSFER', name='payment_method'), autoincrement=False, nullable=True),
    sa.Column('stripe_client_secret', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    ...
    sa.UniqueConstraint('stripe_payment_intent_id', name='payment_stripe_payment_intent_id_key')
    )
